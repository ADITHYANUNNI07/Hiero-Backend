...
var file_pkg_pb_auth_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x32, 0xd0, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x83, 0x01, 0x0a, 0x20, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x55, 0x73, 0x65,
...
var file_pkg_pb_auth_auth_proto_depIdxs = []int32{
	0, // 0: user.AuthService.CheckUserAvalilabilityWithUserID:input_type -> user.CheckUserAvalilabilityWithUserIDRequest
	2, // 1: user.AuthService.UserData:input_type -> user.UserDataRequest
	1, // 2: user.AuthService.CheckUserAvalilabilityWithUserID:output_type -> user.CheckUserAvalilabilityWithUserIDResponse
	3, // 3: user.AuthService.UserData:output_type -> user.UserDataResponse
